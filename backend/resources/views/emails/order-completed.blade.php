...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .order-box { background: #f0fdf4; border: 1.5px solid #bbf7d0; border-radius: 12px; padding: 24px; margin-bottom: 28px; }
    ...
    .order-meta-table td { vertical-align: top; padding-right: 16px; width: 25%; }
    ...
    .meta-value.code { color: #16a34a; font-size: 15px; }
    .meta-value.status { display: inline-block; background: #dcfce7; color: #16a34a; padding: 3px 12px; border-radius: 20px; font-size: 12px; font-weight: 600; }
    ...
    .summary-table tr.total td:last-child { color: #16a34a; }
    ...
    .cta-btn { display: inline-block; padding: 14px 36px; background: linear-gradient(135deg, #16a34a, #22c55e); color: #fff; text-decoration: none; border-radius: 10px; font-size: 15px; font-weight: 700; box-shadow: 0 4px 15px rgba(34,197,94,0.3); }
...
<div class="wrapper">
  ...
  <div class="header">
    ...
    <p>Cảm ơn bạn đã mua sắm tại FiveTech Store</p>
  </div>
  ...
  <div class="body">
    <p class="greeting">
      ...
      Đơn hàng <strong>#{{ $order->order_code }}</strong> của bạn đã được giao thành công. Cảm ơn bạn đã tin tưởng và mua sắm tại FiveTech Store!
    </p>
    ...
    <div class="order-box">
      ...
      <table class="order-meta-table">
        <tr>
          ...
          <td>
            <span class="meta-label">Hoàn thành lúc</span>
            <span class="meta-value">{{ $order->updated_at->format('d/m/Y H:i') }}</span>
          </td>
          <td>
            <span class="meta-label">Trạng thái</span>
            <span class="meta-value"><span class="status">Hoàn thành</span></span>
          </td>
        </tr>
      </table>
    </div>
